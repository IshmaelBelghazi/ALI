...
def create_models():
    ...
    z = gan.theano_rng.normal(size=(x.shape[0], gan.decoder.input_dim))
    ...
    def _create_model(with_dropout):
        ...
        if with_dropout:
            ...
            inputs = VariableFilter(
                bricks=[gan.discriminator], roles=[INPUT])(cg)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Train GAN on Spiral')
    parser.add_argument("--save-path", type=str, default='gan_spiral.tar',
